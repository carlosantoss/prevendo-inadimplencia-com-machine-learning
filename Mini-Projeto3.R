...
setwd("C:/Users/crls-/Documents/PowerBI/Cap15")
getwd()
...
# Definimos os dados de treinamento como subconjunto do conjunto de dados original com números de indice de linha (conforme identificado acima) e todas as colunas
...
# Comparação das porcentagens entre as classes de treinamento e dados originais
